...
def yolo_nms(outputs, anchors, masks, classes):
    ...
    boxes, scores, classes, valid_detections = tf.image.combined_non_max_suppression(
        ...
        max_output_size_per_class=YOLO_MAX_BOXES, #FLAGS.yolo_max_boxes,
        max_total_size=YOLO_MAX_BOXES, #FLAGS.yolo_max_boxes,
        iou_threshold=YOLO_IOU_THRESHOLD, #FLAGS.yolo_iou_threshold,
        score_threshold=YOLO_SCORE_THRESHOLD, #FLAGS.yolo_score_threshold
    )
